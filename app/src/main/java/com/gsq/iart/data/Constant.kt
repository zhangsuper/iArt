...
object Constant {
    ...
    const val COMPLEX_TYPE_NATIVE_COMPARE = "type_native_compare"//本地对比列表
    const val COMPLEX_TYPE_COMPARE = "type_compare"//图单对比列表
    ...
    const val INTENT_DATA_SUB = "intent_data_sub"
