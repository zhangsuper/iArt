...
class DefineLoadMoreView(context: Context) : LinearLayout(context), SwipeRecyclerView.LoadMoreView, View.OnClickListener {
    ...
    override fun onLoading() {
        ...
        mTvMessage.text = appContext.resources.getString(R.string.recyclerview_loading)
    }
    ...
    override fun onLoadFinish(dataEmpty: Boolean, hasMore: Boolean) {
        if (!hasMore) {
            ...
            if (dataEmpty) {
                ...
                mTvMessage.visibility = View.VISIBLE
                mTvMessage.text = appContext.resources.getString(R.string.recyclerview_load_empty)
            } else {
                mProgressBar.visibility = View.GONE
                mTvMessage.visibility = View.VISIBLE
                mTvMessage.text = appContext.resources.getString(R.string.recyclerview_load_end)
            }
        } else {
    ...
    override fun onWaitToLoadMore(loadMoreListener: SwipeRecyclerView.LoadMoreListener) {
        ...
        mProgressBar.visibility = View.GONE
        mTvMessage.visibility = View.VISIBLE
        mTvMessage.text = appContext.resources.getString(R.string.recyclerview_load_complete)
    }
    ...
    override fun onClick(v: View) {
        ...
        mLoadMoreListener?.let {
            if (mTvMessage.text != appContext.resources.getString(R.string.recyclerview_load_end)&&mProgressBar.visibility!=View.VISIBLE){
                it.onLoadMore()
            }
        }
    }
