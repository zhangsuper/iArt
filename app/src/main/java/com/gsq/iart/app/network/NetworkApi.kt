...
import com.gsq.mvvm.network.BaseNetworkApi
import com.gsq.mvvm.network.interceptor.CacheInterceptor
import com.gsq.mvvm.network.interceptor.logging.LogInterceptor
...
class NetworkApi : BaseNetworkApi() {
    ...
    override fun setHttpClientBuilder(builder: OkHttpClient.Builder): OkHttpClient.Builder {
        builder.apply {
            //设置缓存配置 缓存最大10M
            cache(Cache(File(appContext.cacheDir, "iart_cache"), 10 * 1024 * 1024))
            //添加Cookies自动持久化
            cookieJar(cookieJar)
